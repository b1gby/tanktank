...
Original file is located at
    https://colab.research.google.com/drive/1FXVGOMchtnzzM2IwrJMzscW08-VGfGi1
"""

## connect Google Drive
# from google.colab import drive
# drive.mount('/content/drive') #, force_remount=True
model_dir = '/Users/sover/Desktop/tank/'
...
# %cd /content/tanktank/gym_tank/envs
...
policy_net = DQN(screen_height, screen_width, n_actions).to(device)
target_net = DQN(screen_height, screen_width, n_actions).to(device)
target_net.load_state_dict( torch.load(model_dir + "target_net.pth")     #  policy_net.state_dict()
)

policy_net.load_state_dict( torch.load(model_dir + "policy_net.pth")     #  policy_net.state_dict()
)
